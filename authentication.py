"""
Code by Macuyiko: https://blog.macuyiko.com/post/2016/how-to-send-html-mails-with-oauth2-and-gmail-in-python.html
...
with open(configurations.CREDENTIALS) as file:
    credentials = json.load(file)

GOOGLE_CLIENT_ID = credentials["installed"]["client_id"]
GOOGLE_CLIENT_SECRET = credentials["installed"]["client_secret"]
GOOGLE_REFRESH_TOKEN = "1//09qIuqq39kpgFCgYIARAAGAkSNwF-L9Irc7a--canHoBbIkVJyACB9ckkSfGNAadHknFA08C3S24zi7wm64gnIBoJu6ZQKaE64VI"

#"1//03d4dGLLQRlwwCgYIARAAGAMSNwF-L9Ir2O1jLAJICxpZZWyEieOEvJfI5FsCUkJxHLggX33FKinSSGkgFcDAcrpHiRu031-Gwb8"
